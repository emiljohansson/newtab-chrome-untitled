...
(function() {
  ...
  */
  ...
  (function() {
    ...
    var c = "undefined" === typeof HTMLTemplateElement,
      d = !(document.createDocumentFragment().cloneNode() instanceof window.DocumentFragment),
      e = !1;
    /Trident/.test(navigator.userAgent) && function() {
      function a(a, b) {
        if (a instanceof window.DocumentFragment)
      ...
      Node.prototype.cloneNode = function(a) {
        a = b.call(this, a);
        this instanceof window.DocumentFragment && (a.__proto__ = window.DocumentFragment.prototype);
        return a
      };
      window.DocumentFragment.prototype.querySelectorAll = HTMLElement.prototype.querySelectorAll;
      window.DocumentFragment.prototype.querySelector = HTMLElement.prototype.querySelector;
      ...
      Node.prototype.appendChild = function(b) {
        b instanceof window.DocumentFragment ? a.call(this, b, null) : d.call(this, b);
        return b
      };
      var f = Node.prototype.removeChild,
        h = Node.prototype.replaceChild;
      Node.prototype.replaceChild = function(b, c) {
        b instanceof window.DocumentFragment ? (a.call(this, b, c), f.call(this, c)) : h.call(this, b, c);
        return c
      };
    ...
    if (c) {
      ...
      var hf = ba("area base br col command embed hr img input keygen link meta param source track wbr".split(" ")),
        ...
        nb = function(a, b) {
          ...
          for (var c = "", d = b ? b(a) : a.childNodes, e = 0, f =
              d.length, h; e < f && (h = d[e]); e++) {
            a: {
              var g = h;
              var k = a;
              var l = b;
      ...
      var ya = function(c, d) {
        ...
        Ma = Node.prototype.cloneNode = function(b) {
          if (!e && d && this instanceof DocumentFragment)
            ...
            this.nodeType === Node.ELEMENT_NODE && "template" === this.localName && this.namespaceURI == document.documentElement.namespaceURI ? a.ha(this, b) : f.call(this, b);
          b && ya(c, this);
          return c
        },
        jf = Document.prototype.importNode = function(c, d) {
          ...
          if (d) {
            ...
            for (var f, k = 0; k < c.length; k++) {
              ...
              for (var l =
                  f.attributes, ka = 0, xa; ka < l.length; ka++) xa = l[ka], d.setAttribute(xa.name, xa.value);
  ...
  var pa = 0,
    qa, ra = "undefined" !== typeof window ? window : void 0,
    sa = ra || {},
  ...
  function Aa() {
    for (var a = 0; a < pa; a += 2)(0, Ea[a])(Ea[a + 1]), Ea[a] = void 0, Ea[a + 1] = void 0;
    pa = 0
  }
  var Fa, Ga;
  if ("undefined" === typeof self && "undefined" !== typeof process && "[object process]" === {}.toString.call(process)) Ga = function() {
  ...
  function eb(a) {
    var b = a.L,
      c = a.h;
    if (0 !== b.length) {
      for (var d, e, f = a.f, h = 0; h < b.length; h += 3) d = b[h], e = b[h + c], d ? Ta(c, d, e, f) : e(f);
      a.L.length = 0
    }
  }
  ...
  */
  ...
  (function(a) {
    ...
    k.prototype.Wa = function(a, b) {
      ...
      if (c = a.querySelector("base")) b = D.aa(c.getAttribute("href"), b), c.removeAttribute("href");
    ...
    var wa = null;
    if (C) t = m(document, "link[rel=import]"), n(t, function(a) {
  ...
  */
  ...
  if (!w.noOpts) {
    ...
    if (qb)
      for (var sb = 0, tb; tb = qb.attributes[sb]; sb++) "src" !== tb.name && (w[tb.name] = tb.value || !0);
  ...
  */
        ...
        set: function(a) {
          ...
          switch (this.nodeType) {
            ...
            case Node.DOCUMENT_FRAGMENT_NODE:
              ...
              } else Dc(this), (0 < a.length || this.nodeType === Node.ELEMENT_NODE) && this.appendChild(document.createTextNode(a));
              break;
            default:
              this.nodeValue = a
          }
  ...
  var Rc = z.w ? function() {} : function(a) {
      var b = x(a);
      b.qa || (b.qa = !0, L(a, Jc, !0), L(a, Kc, !0))
    },
    Sc = z.w ? function() {} : function(a) {
  ...
  function bd(a, b, c) {
    if (a = (a = y(a)) && a.J) b && a.addedNodes.push(b), c && a.removedNodes.push(c), Tb(a)
  }
  ...
  function xd(a, b, c) {
    if (c = b.__handlers && b.__handlers[a.type] && b.__handlers[a.type][c])
      for (var d = 0, e;
        (e = c[d]) && (!wd(a) || a.target !== a.relatedTarget) && (e.call(b, a), !a.i); d++);
  }
  ...
  function yd(a) {
    ...
    for (c = 0; c < b.length; c++) {
      ...
      f = f && f.root;
      if (0 === c || f && f === e)
        if (xd(a, d, "bubble"), d !== window && (e = d.getRootNode()), a.a) break
    }
  }
        ...
        if ("object" !== d || b.handleEvent && "function" === typeof b.handleEvent) {
          ...
          k = function(e) {
            ...
            if (e.composed || -1 < e.composedPath().indexOf(g))
              if (wd(e) && e.target === e.relatedTarget) e.eventPhase === Event.BUBBLING_PHASE && e.stopImmediatePropagation();
  ...
  function Nd(a) {
    for (var b; a;) {
      a.V && (b = a);
      a: {
        var c = a;a = c.host.getRootNode();
        if (A(a))
          for (var d = c.host.childNodes, e = 0; e < d.length; e++)
            if (c = d[e], "slot" == c.localName) break a;a = void 0
      }
    }
    b && b._renderRoot()
  }
    ...
    if (this.g) {
      ...
      for (a = 0; a < b.length; a++) {
        ...
        for (var k = g = 0; g < h.length && (d = h[g]); g++) {
          for (var l = 0, m; l < d.P.length && (m = d.P[l]); l++) ed(m) === c && B.removeChild.call(c, m), f.splice(d.index + k, 1);
          k -= d.W
        }
        for (k = 0; k < h.length && (d = h[k]); k++)
          for (g = f[d.index], l = d.index; l < d.index + d.W; l++) m = e[l], B.insertBefore.call(c, m, g), f.splice(l, 0, m)
      }
    }
  };
  ...
  function ne(a) {
    if (!1 !== a.S) {
      a.S = !1;
      for (var b = a.ka, c = [], d = new Map, e = 0; e < b.length; e++) d.set(b[e].localName, []);
      S(a.l, document, {
        ba: function(b) {
          if (void 0 === b.__CE_state) {
            var e = b.localName,
  ...
  var oe = window.Document.prototype.createElement,
    ...
    Ae = Object.getOwnPropertyDescriptor(window.Node.prototype,
      "textContent"),
  ...
  function We() {
    ...
    window.HTMLElement = function() {
      function b() {
        ...
        if (0 === e.length) return e = oe.call(document, d.localName), Object.setPrototypeOf(e, b.prototype), e.__CE_state = 1, e.__CE_definition = d, a.b(e), e;
        d = e.length - 1;
        var f = e[d];
  ...
  function kf(a, b) {
    ...
    if (c = a.rules)
      for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) kf(f,
        b);
    return a
  }
  ...
  function Dg(a, b, c, d) {
    ...
    if (b.m.A) {
      ...
      if (h || g) c = e, g && (b.o || (b.o = Zf(W, b, W.b, a ? Yf + a : "", e)), c = b.o || e), d({
        ab: c,
        Ua: g,
        tb: h
      })
        ...
        for (var d = 0; d < c.addedNodes.length; d++) {
          ...
          if (e.nodeType === Node.ELEMENT_NODE) {
            ...
            if ((h = -1 < g ? h[g + 1] : "") && f === e.ownerDocument) Rf(e, h, !0);
              ...
              (f = f.host))
              if (f = Pf(f).is, h === f)
                for (e = window.ShadyDOM.nativeMethods.querySelectorAll.call(e, ":not(." + W.a + ")"), f = 0; f < e.length; f++) Tf(e[f], h);
  ...
  function Wg(a) {
    if (a = Ug[a]) a._applyShimCurrentVersion = a._applyShimCurrentVersion || 0, a._applyShimValidatingVersion = a._applyShimValidatingVersion || 0, a._applyShimNextVersion = (a._applyShimNextVersion || 0) + 1
  }
  ...
  p.prepareTemplate = function(a, b, c) {
    if (!a.Ma) {
      ...
      d = [];
      V || (d = xg(a._styleAst));
      if (!d.length || V) e = U ? a.content : null, b = Kg[b], f = Vf(c, a._styleAst), b = f.length ? Kf(f, c.is, e, b) : void 0, a.sa = b;
      a.La = d
    }
  };
      ...
      if (this.b.enqueued) {
        if (V)
          for (var b = 0; b < a.length; b++) {
            ...
            for (fh(this, this.c, this.i), b = 0; b < a.length; b++)(c = this.b.getStyleForCustomStyle(a[b])) && Ig(c, this.i.F);
        this.b.enqueued = !1;
  ...
  p.styleElement = function(a, b) {
    ...
    if (V) {
      ...
      if (((k = Ug[c]) || a === this.c) && k && k.sa && !Xg(k)) {
        if (Xg(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion) dh(this), this.a && this.a.transformRules(k._styleAst, c), k.sa.textContent =
          Vf(a, d.B), Yg(k);
      ...
      U ? f.a ? (f.a.textContent = e, d = f.a) : e && (d = Kf(e, g, a.shadowRoot, f.b)) : d ? d.parentNode ||
        (vg && -1 < e.indexOf("@media") && (d.textContent = e), Lf(d, null, f.b)) : e && (d = Kf(e, g, null, f.b));
